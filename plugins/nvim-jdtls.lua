...
return {
  {
    ...
    opts = function(_, opts)
      ...
      if vim.fn.has "mac" == 1 then
        WORKSPACE_PATH = home .. "/Program/java/vim/jdtls_workspace/"
        OS = "mac"
        ...
        settings = {
          java = {
            ...
            format = {
              enabled = true,
              settings = {
                url = "/home/admin/.config/nvim/lua/user/formatter/eclipse-java-custom-style.xml",
                profile = "GoogleStyle",
              },
            },
          },
      ...
      vim.api.nvim_create_autocmd("Filetype", {
        ...
        callback = function()
          if opts.root_dir and opts.root_dir ~= "" then
            ...
            -- add command to set runtime and update jdtls config
